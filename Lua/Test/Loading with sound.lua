...
Image.Image = "rbxassetid://83497866000186" -- Your image ID here
...
loadingSound.SoundId = "rbxassetid://139797902"  -- This is the sound ID you provided
loadingSound.Parent = SoundService  -- Parent the sound to SoundService
loadingSound.Looped = true  -- Set the song to loop
loadingSound:Play()  -- Play the song immediately
...
-- Destroy the loading screen after effects
