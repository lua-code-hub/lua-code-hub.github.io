...
-- Use secure GUI methods
local GUI_Parent = (gethui and gethui()) or (get_hidden_gui and get_hidden_gui()) or game:GetService("CoreGui")
...
ScreenGui.Name = math.random(1, 999999) .. "_EnhancedOwlMenu"
...
gameName = success and gameName or "Game"
...
local function loadScript()
    ...
    local scriptUrl = gameScripts[gameId] or gameScripts["default"]
