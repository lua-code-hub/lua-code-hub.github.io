...
local smoothnessSlider = CreateSlider(AimbotPage, "Smoothness", "Aimbot", "Smoothness", 0, 10, 0)
...
local smoothness = Settings.Aimbot.Smoothness == 0 and 1 or Settings.Aimbot.Smoothness
